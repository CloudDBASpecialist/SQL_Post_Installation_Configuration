...
-- Execute the command after the query results are displayed
DECLARE @CommandToExecute NVARCHAR(1000)
SET @CommandToExecute = 'EXEC sp_configure ''max server memory'', ' + CAST(CAST(@memForSql * 1024 AS INT) AS VARCHAR(10)) + ' RECONFIGURE'
